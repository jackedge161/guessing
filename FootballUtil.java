...
public class FootballUtil {
     ...
     * @return
     */
    public static List<BallCombinationVO> getOptions(FootballMatchDTO footballMatchDTO, List<Map<String, Object>> oddlist) {
        List<BallCombinationVO> footballCombinationVOList = new ArrayList<>();
    ...
    public static List<BallCombinationVO> getAllOptions(FootballMatchDTO footballMatchDTO) {
        ...
        footballCombinationVOList.addAll(getOptions(footballMatchDTO, footballMatchDTO.getLetOddsList()));
    ...
    public static BallCalculationVO calculation(List<FootballMatchDTO> footballMatchList, Integer multiple, List<Integer> pssTypeList) {
        ...
        footballOptimization.addAll(getFootballOptimizationVOlist(footballOptimizationz, multiple));
        ...
        for (int i = 1; i < pssTypeList.size(); i++) {
            ...
            footballOptimizationz = getallfootballOptimization(footballMatchList, Indexgroup);
            footballOptimization.addAll(getFootballOptimizationVOlist(footballOptimizationz, multiple));
        }
        ...
        footballCalculation.setAverageOptimizationList(footballOptimization);
